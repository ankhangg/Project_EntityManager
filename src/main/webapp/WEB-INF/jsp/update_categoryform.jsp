						...
						<form:form modelAttribute="categoryupdate" enctype="multipart/form-data" method="POST" action="updatecategory"> 
							<div class="row">
								...
								<!-- Not show on screen start -->
                                        <div class="col">
                                       <form:hidden path="cateprodId" value="${categoryupdate.cateprodId }"/>
                                            </div>
                                       <div class="col">
                                       <form:hidden path="informationControl.modifiedBy" value="${pageContext.request.userPrincipal.name}"/>
                                            </div>
